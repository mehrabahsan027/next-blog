...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="flex-1 flex flex-col items-center justify-center py-12 px-4 sm:py-16 md:py-20 text-center">
        <div className="space-y-6 max-w-3xl w-full mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/60">
            Welcome to My Blog
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            A modern blog built with Next.js 16, featuring real time data with
            Convex, a clean Tailwind CSS design, and shadcn/ui components.
          </p>
          <div className="flex flex-col sm:flex-row w-full items-center justify-center gap-4 pt-6">
      ...
      <section className="py-12 px-4 sm:py-16">
        <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-full max-w-6xl mx-auto">
